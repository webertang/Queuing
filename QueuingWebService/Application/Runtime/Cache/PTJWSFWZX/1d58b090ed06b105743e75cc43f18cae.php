...
<html>
	...
	<script src="/Public/Base/js/jquery-2.1.4.min.js"></script>
	...
	<body>
		<div id="date"></div>
		<div id="time"></div>
		<div style="position:absolute;top:0px;left: 0px; width:1920px; height:1080px; z-index:-1;background-image: url('/Public/PTJWSFWZX/images/background.jpg');">
